...
<div class="main-card">
    <div class="header">
        {{ trans('global.create') }} {{ trans('cruds.scooter.title_singular') }}
    </div>
    ...
    <form method="POST" action="{{ route("admin.scooters.store") }}" enctype="multipart/form-data">
        ...
        <div class="body">
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="number" id="phone" name="phone" class="{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" required>
                </div>
                @if($errors->has('phone'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="number" id="barcode" name="barcode" class="{{ $errors->has('barcode') ? ' is-invalid' : '' }}" value="{{ old('barcode') }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="model" name="model" class="{{ $errors->has('model') ? ' is-invalid' : '' }}" value="{{ old('model') }}" required>
                </div>
                @if($errors->has('model'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="termen" name="termen" class="{{ $errors->has('termen') ? ' is-invalid' : '' }}" value="{{ old('termen') }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <textarea id="problem" name="problem" class="w-full px-3 py-2 {{ $errors->has('problem') ? ' is-invalid' : '' }}" required>{{ old('problem') }}</textarea>
                </div>
